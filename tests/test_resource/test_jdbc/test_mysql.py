...
class TestResource(TestCase):
    ...
    def test_execute_insert(self):
        ...
        cursor_mock.execute.assert_has_calls([call('SELECT LAST_INSERT_ID(NULL)'),
    ...
    def test_execute_select_with_include_metadata(self):
        ...
        dummy = MySQLJDBC(connection_mock, transaction_id='123')
        dummy.use_database = Mock()
        with mock.patch('local_data_api.resources.jdbc.mysql.create_column_metadata_set') \
                as create_column_metadata_set_mock:
            create_column_metadata_set_mock.side_effect = [[ColumnMetadata(arrayBaseColumnType=0,
            ...
            self.assertEqual(
                dummy.execute("select * from users", database_name='test', include_result_metadata=True),
